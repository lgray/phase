...
/// CR 903.9a / CR 704.5j / CR 310.10). The invariant this guard actually needs is weaker
/// and true:
...
/// exempt for two DIFFERENT reasons, and the weaker invariant is what covers both:
