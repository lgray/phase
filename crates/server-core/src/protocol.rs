...
mod tests {
    ...
    /// source_incarnation }` in serialized full-game state; a v78 peer cannot
    ...
    #[test]
    fn protocol_version_is_79_for_exile_look_authority() {
    ...
    /// `protocol_version_is_79_for_exile_look_authority` stays
